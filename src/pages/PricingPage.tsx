              ...
              <FadeIn key={plan.name} delay={i * 0.08}>
                <motion.div whileHover={{ y: -6 }}
                  ...
                  <Link to="/contact"
                    ...
                    style={{
                      background: plan.popular ? GOLD : 'rgba(232,184,75,0.1)',
                      color: plan.popular ? DARK : GOLD,
                      border: plan.popular ? 'none' : '1px solid rgba(232,184,75,0.25)',
                    }}
                    onMouseEnter={e => { e.currentTarget.style.background = plan.popular ? '#d4a017' : 'rgba(232,184,75,0.2)'; }}
                    onMouseLeave={e => { e.currentTarget.style.background = plan.popular ? GOLD : 'rgba(232,184,75,0.1)'; }}>
                    Get Started
                  </Link>
                </motion.div>
              </FadeIn>
          ...
          <FadeIn>
            <div className="rounded-2xl p-8 sm:p-10" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(232,184,75,0.1)' }}>
