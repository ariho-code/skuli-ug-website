...
/* Each headline line rises out of its own mask on load. */
function HeroLine({ children, index }: { children: ReactNode; index: number }) {
  ...
  return (
    <div style={{ background: INK, color: '#fff' }}>
      ...
      <section className="relative flex items-center overflow-hidden pt-28 sm:pt-32 pb-16" style={{ minHeight: '100svh' }}>
        ...
        <div className="grain" />
        <div className="aurora absolute -top-32 right-[-10%] w-[640px] h-[640px] rounded-full pointer-events-none"
          style={{ background: `radial-gradient(circle at 60% 40%, rgba(245,122,18,.30), transparent 65%)`, filter: 'blur(10px)' }} />
        <div className="absolute -bottom-40 -left-32 w-[520px] h-[520px] rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(18,58,102,.5), transparent 70%)', filter: 'blur(50px)' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-8 items-center w-full">
          ...
          <div>
            <h1 className="font-display font-extrabold tracking-tight leading-[1.04] mb-6" style={{ fontSize: 'clamp(2.5rem,7vw,4.6rem)' }}>
              ...
              <HeroLine index={2}>Finally.</HeroLine>
            </h1>
            <FadeIn delay={0.45}>
          ...
          {/* product visual */}
          <FadeIn delay={0.3} className="relative flex justify-center lg:justify-end lg:pr-6">
            <div className="relative">
              {/* phone with the real app screenshot */}
          ...
          <div>
            ...
            <FadeIn delay={0.15}>
              <p className="text-white/60 text-lg text-pretty mb-6 max-w-lg">
                Teachers enter marks. Skuli drafts a personalised, professional comment for every single pupil and saves hours of writing at the end of every term. Edit, approve, print.
              </p>
            ...
            <div className="rounded-3xl p-5 sm:p-6 shadow-2xl" style={{ background: 'rgba(11,34,66,0.8)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <div className="rounded-2xl p-4" style={{ background: 'rgba(245,122,18,0.08)', border: '1px solid rgba(245,122,18,0.2)' }}>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[11px] font-semibold" style={{ color: GOLD }}>Comment drafted by Skuli</span>
                </div>
                <AiComment />
              </div>
            </div>
      ...
      <section id="pricing" className="py-20 sm:py-28" style={{ background: CREAM, color: '#0C2C57' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-12 sm:mb-14">
            ...
            <FadeIn delay={0.15}>
              <p className="mt-4 text-lg text-pretty" style={{ color: 'rgba(12,44,87,0.55)' }}>No per-teacher fees. No hidden charges. One flat payment per term based on your school size. Three terms a year, and that's all you pay.</p>
            </FadeIn>
          </div>
          ...
          <FadeIn className="mt-7">
            <div className="rounded-3xl px-6 sm:px-8 py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5" style={{ background: INK, color: '#fff' }}>
              <p className="text-white/80 text-[15px] max-w-2xl"><span className="font-bold text-white">Want a system built for your school specifically?</span> We build fully bespoke school systems with your branding, your workflow and your features.</p>
